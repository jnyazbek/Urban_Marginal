...
public class Connection extends Thread {
	...
	/**
	 * Constructeur : crée une connexion é partir d'un socket (contenant les spécificités de l'ordinateur distant)
	 ...
	 * @param unObjet contieny l'objet é envoyer
	 */
	 ...
	 */
	public void run() {
		// permet de savoir s'il faut continuer é écouter
		boolean inOk = true ;
		// objet qui va récupérer l'information reéue
		Object reception ;
		...
		while (inOk) {
			try {
				...
				// envoi de l'information reéue vers la classe qui implémente AsyncResponse pour récupérer la réponse
				delegate.reception(this, "réception", reception);
			} catch (ClassNotFoundException e) {
				// probléme grave qui ne devrait pas se produire : arrét du programme
				...
				// demande d'arréter de boucler sur l'attente d'une réponse
				inOk = false ;
