 ...
 * afin de libérer la mémoire et le flux oé se trouve le son. <br>
    ...
    implements Serializable, Runnable
{
  ...
  //Clip jouant le son
  private Clip clip;
  //Thread permettant de jouer le son en téche de fond
  private Thread thread;
  //Nombre de boucle restante é effectué
  private int tour;
  //pause : inqique si le son est en pause ou non
  //fermerALaFin : indique si le son doit étre détruit une fois la derniére boucle de son exécutée
  private boolean pause, fermerALaFin;
  //Ecouteurs des événement sons
  private Vector ecouteurs = new Vector();
  /**
   * Construit un son situé é une URL précise
  ...
  /**
   * Construit un son é partir d'un fichier
      ...
      throws SonException
  {
    try
    {
      ...
      //Grac é cette information, on peut creer un clip
  ...
  public void run()
  {
    ...
    while(this.thread != null)
    {
      ...
      if(this.tour > 0)
      {
        ...
        //On é un tour de moins é jouer
        this.tour--;
        if(this.tour < 1)
        {
          //Si on a fini de jouer, on tremine
          this.terminer();
          //Si on doit fermer é la fin, on ferme définitivement le son
  ...
  public void pause()
  {
    //Si on est pas déjé en pause, on se met en pause
    if(!this.pause)
    {
      this.clip.stop();
      this.pause = true;
  ...
  /**
   * Reprend le son ou il était rendu (enléve la pause)
   */
  public void reprise()
  {
  ...
  /**
   * Arréte de jouer le son et retour du son au début
   */
  public void stop()
  {
    this.clip.stop();
  ...
  /**
   * Change l'état de fermeture é la fin
  ...
  /**
   * Place le son é cette durée en milliseconde.
   * @param microseconde Place é laquelle on désire commencé le son
   */
  ...
  /**
   * Place le son é cette durée
   * @param duree Place é laquelle on désire commencé le son
   */
  ...
  /**
   * Indique si le son est entrain d'étre jouer
   * @return <b>true</b> si le son est entrain d'étre joué
   */
  ...
  //Indique é tout les écouteurs d'événements son, que le son est terminé
  ...
  //Indique é tout les écouteurs d'événements son, que le son a avancé
