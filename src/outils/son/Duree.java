...
public class Duree implements Serializable
{
  ...
  public Duree(int microseconde)
  {
    if(microseconde < 0)
    {
      throw new IllegalArgumentException(
          "Le nombre de microsecondes ne peut pas étre négative");
    }
    if(microseconde > 999999)
    {
      throw new IllegalArgumentException("Le nombre de microsecondes ne peut pas étre plus de 999999, sinon on a des secondes");
    }
  ...
  public Duree(int seconde, int microseconde)
  {
    ...
    {
      throw new IllegalArgumentException(
          "Le nombre de secondes ne peut pas étre négative");
    }
    if(seconde > 59)
    {
      throw new IllegalArgumentException(
          "Le nombre de secondes ne peut pas étre plus de 59, sinon on a des minutes");
    }
  ...
  public Duree(int minute, int seconde, int microseconde)
  {
    ...
    {
      throw new IllegalArgumentException(
          "Le nombre de minutes ne peut pas étre négative");
    }
    if(minute > 59)
    {
      throw new IllegalArgumentException(
          "Le nombre minutes ne peut pas étre plus de 59, sinon on a des heures");
    }
    this.minute = minute;
  ...
  public Duree(int heure, int minute, int seconde, int microseconde)
  {
    ...
    {
      throw new IllegalArgumentException(
          "Le nombre d'heure ne peut pas étre négative");
    }
    this.heure = heure;
